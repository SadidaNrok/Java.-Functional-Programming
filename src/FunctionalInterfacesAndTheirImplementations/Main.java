...
class Main {
    ...
    public static void printFilteredAccounts(List<Account> accounts) {
        List<Account> nonEmptyAccounts = filter(accounts, n -> n.getBalance() > 0);// write your code here
        List<Account> accountsWithTooMuchMoney = filter(accounts, n -> !n.isLocked() && n.getBalance() >= 100000000L);// write your code here
